...
const ProfilePage = () => {
  ...
  return (
    <div className="min-h-screen pt-20 px-4 sm:px-6 md:px-10 bg-base-100">
      <div className="max-w-3xl mx-auto w-full py-8">
        <div className="bg-base-300 rounded-xl p-6 sm:p-8 space-y-8 shadow-xl">
          {/* Title */}
          ...
          <div className="flex flex-col items-center gap-4">
            <div className="relative">
              <img
                ...
                alt="Profile"
                className="w-28 h-28 sm:w-32 sm:h-32 rounded-full object-cover border-4 border-base-100"
              />
              <label
          ...
          <div className="mt-6 bg-base-300 rounded-xl p-6 border border-base-200">
            ...
            <div className="space-y-3 text-sm">
              <div className="flex flex-wrap justify-between py-2 border-b border-zinc-700">
